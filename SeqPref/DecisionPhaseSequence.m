...
DrawFormattedText(display.windowPtr, sprintf('%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s', ...
    'This is the Decision Phase. This phase takes around 15 minutes.', ...
...
KbStrokeWait;
DrawFormattedText(display.windowPtr, sprintf('%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s', ...
    'For each decision, there will be two deck of cards for you to choose between.', ...
    'MAKE EACH DECISION CAREFULLY, because each time', ...
